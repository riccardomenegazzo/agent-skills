...
| `<!-- eval:cloudformation -->` | Force classification as an AWS CloudFormation or AWS SAM template; checks YAML structure and explicit Lambda package/layer invariants without replacing AWS schema validation. |
